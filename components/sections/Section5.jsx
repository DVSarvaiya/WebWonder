    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        {particles.map((style, i) => (
          <div key={i} className="phosphorescent-particle" style={style} />
        ))}
      </div>
      ...
      {/* Hidden discovery */}
      <div className="absolute bg-black bottom-32 left-1/2 transform -translate-x-1/2">
        {!discovered ? (
          <button
          ...
          <div className="text-center bg-black/100 space-y-6 animate-fade-in">
            <div className="bg-black rounded-2xl p-8 border border-cyan-400/30 max-w-2xl">
